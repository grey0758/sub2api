export default {
    accounts: {
      ...
      hourlySpend: {
        title: 'Hourly spend limit',
        description: 'Stop assigning new requests to this account after its settled spend reaches the limit. Scheduling resumes when the fixed 60-minute window ends.',
        limitLabel: 'Limit per hour (USD)',
        limitHint: 'Requests already in progress can make the final amount slightly exceed the limit.',
        invalidLimit: 'Enter an hourly spend limit greater than $0.',
        off: 'Off',
        ready: 'Ready',
        active: 'Tracking',
        capped: 'Capped',
        ...
        startsOnUse: 'Starts on next billed request'
      },
      expiresAt: 'Expires At',
